 const themeBtn = document.getElementById("th");
        ...
        floatingCommentForm.addEventListener('submit', async (event) => {
            ...
            if (!name) {
                showToast('Please enter your anonymous name');
                return;
            }

            if (!message) {
                showToast('Please enter your anonymous message');
                return;
            }

            if (!device) {
                showToast('Device is required');
                return;
            }
            ...
            try {
                ...
                if (isSpam || isDailyLimit) {
                    ...
                    showToast('You have already sent 3 messages today');
                    return;
                }
                ...
                if (error.message === 'success') {
                    showToast('This message has already been sent');
                }
                else {
                    showToast('error');
                }
